import { altPart1, altPart2, calculateCO2ScrubberRating, calculateOxygenGeneratorRating, parseDecimal, parseInput } from './altDay3'
...
test('part 1 example input should return 198', () => {
  expect(altPart1(sampleInput)).toBe(198)
})
